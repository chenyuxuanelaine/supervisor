...
namespace {
    ...
    /**
     * RpcClient 配置文件在config/rpc.php 下
     * @example $results = \RpcClient::rpc_fun('a','b');
     * @example 一次请求调用多个函数 $results =  \RpcClient::batch()
                  ->rpc_fun1(['arg1' => 'bar'])
                  ->rpc_fun2(1, 100)
                  ->rpc_fun3(4, 3)
                  ->execute('rpc_fun4', [2, 5])
                  ->send();
                  这里会返回结果集数组
     * @author huangguoliang
     *
     */
//    class RiskClient extends \App\Providers\LumenRpc\Facades\RpcClientFacade{
//        /**
//         * Execute a procedure
//         *
//         * @access public
...
//         * @return mixed
//         */
//        public static function execute($procedure, array $params = array(), array $reqattrs = array()){
//            return \App\Providers\LumenRpc\RpcClientWrapper::execute($procedure, $params, $reqattrs);
//        }
//        /**
...
//            return \App\Providers\LumenRpc\RpcClientWrapper::batch();
//        }
//
//    }
    ...
    /**
     * OpenClient 配置文件在config/open_rpc.php 下
     * @example $results = \OpenClient::rpc_fun('a','b');
     * @example 一次请求调用多个函数 $results =  \OpenClient::batch()
    ->rpc_fun1(['arg1' => 'bar'])
    ->rpc_fun2(1, 100)
    ->rpc_fun3(4, 3)
    ->execute('rpc_fun4', [2, 5])
     ...
     *
     */
//    class OpenClient extends \App\Providers\LumenRpc\Facades\RpcClientFacade{
//        /**
//         * Execute a procedure
//         *
//         * @access public
...
//    class RpcServer extends \App\Providers\LumenRpc\Facades\RpcServerFacade{
//        /**
...
//         * @return $this
//         */
//        public static function withCallback($procedure, $callback){
//            return  \App\Providers\LumenRpc\RpcServerWrapper::withCallback($procedure, $callback);
//        }
//        /**
...
//         * @return $this
//         */
//        public static function withClassAndMethod($procedure, $class, $method = ''){
//            return  \App\Providers\LumenRpc\RpcServerWrapper::withClassAndMethod($procedure, $class, $method = '');
//        }
//        /**
...
//            return \App\Providers\LumenRpc\RpcServerWrapper::execute();
//        }
//    }
}
